...
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/SSB_re_under2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Neg. Bias", 6), rep("Linear Neg. Bias", 6), rep("Curv. Neg. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Neg. Bias", "Linear Neg. Bias", "Curv. Neg. Bias",  "AE Est"), 6))
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/SSB_re_over2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Pos. Bias", 6), rep("Linear Pos. Bias", 6), rep("Curv. Pos. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Pos. Bias", "Linear Pos. Bias", "Curv. Pos. Bias", "AE Est"), 6))
par(mfrow = c(4,5), mar = c(2,2, 1, 1), oma=c(4,4,2,2))
for (i in (1:30)[-takeout_ind]){
  boxplot(SSB_re[[i]], ylim = c(-0.75, 0.75), xlim = c(1, 70), axes = FALSE,frame = TRUE)
  mtext(text=paste0("SM = ", OM_Title[i], ", EM = ", EM_Title[i]), side=3, line=0.15, cex=1, font=2)
  mtext(text=paste0("Convergence = ", summary_percent_true[i,4],"%"), side=1, line=-1, cex=1.3)
  if(i %in% c(8,15,22,29)){mtext(text=paste0("Convergence = ", summary_percent_true[i,4],"%"), side=1, line=-1, cex=1.3, col=2)}
  if(i %in% 26:30){
    axis(1, at = seq(10, 70, by=10), labels = seq(10, 70, by=10), cex.axis = 1.75)
    axis(1, at = 1, labels = 1, cex.axis = 1.75)
  }
  if(i %in% c(8,14,20,26)){
...
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/F_ratio_under2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Neg. Bias", 6), rep("Linear Neg. Bias", 6), rep("Curv. Neg. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Neg. Bias", "Linear Neg. Bias", "Curv. Neg. Bias",  "AE Est"), 6))
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/F_ratio_over2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Pos. Bias", 6), rep("Linear Pos. Bias", 6), rep("Curv. Pos. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Pos. Bias", "Linear Pos. Bias", "Curv. Pos. Bias", "AE Est"), 6))
par(mfrow = c(4,5), mar = c(2,2, 1, 1), oma=c(4,4,2,2))
for (i in (1:30)[-takeout_ind]){
...
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/B_ratio_under2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Neg. Bias", 6), rep("Linear Neg. Bias", 6), rep("Curv. Neg. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Neg. Bias", "Linear Neg. Bias", "Curv. Neg. Bias",  "AE Est"), 6))
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/B_ratio_over2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Pos. Bias", 6), rep("Linear Pos. Bias", 6), rep("Curv. Pos. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Pos. Bias", "Linear Pos. Bias", "Curv. Pos. Bias", "AE Est"), 6))
par(mfrow = c(4,5), mar = c(2,2, 1, 1), oma=c(4,4,2,2))
for (i in (1:30)[-takeout_ind]){
...
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/F_ratio_raw_under2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Neg. Bias", 6), rep("Linear Neg. Bias", 6), rep("Curv. Neg. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Neg. Bias", "Linear Neg. Bias", "Curv. Neg. Bias",  "AE Est"), 6))
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/F_ratio_raw_over2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Pos. Bias", 6), rep("Linear Pos. Bias", 6), rep("Curv. Pos. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Pos. Bias", "Linear Pos. Bias", "Curv. Pos. Bias", "AE Est"), 6))
par(mfrow = c(4,5), mar = c(2,2, 1, 1), oma=c(4,4,2,2))
for (i in (1:30)[-takeout_ind]){
...
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/B_ratio_raw_under2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Neg. Bias", 6), rep("Linear Neg. Bias", 6), rep("Curv. Neg. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Neg. Bias", "Linear Neg. Bias", "Curv. Neg. Bias",  "AE Est"), 6))
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/B_ratio_raw_over2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Pos. Bias", 6), rep("Linear Pos. Bias", 6), rep("Curv. Pos. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Pos. Bias", "Linear Pos. Bias", "Curv. Pos. Bias", "AE Est"), 6))
par(mfrow = c(4,5), mar = c(2,2, 1, 1), oma=c(4,4,2,2))
for (i in (1:30)[-takeout_ind]){
...
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/fratio_bratio_raw_fy_under2.tiff"), height=25, width=35, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Neg. Bias", 6), rep("Linear Neg. Bias", 6), rep("Curv. Neg. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Neg. Bias", "Linear Neg. Bias", "Curv. Neg. Bias",  "AE Est"), 6))
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/fratio_bratio_raw_fy_over2.tiff"), height=25, width=35, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Pos. Bias", 6), rep("Linear Pos. Bias", 6), rep("Curv. Pos. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Pos. Bias", "Linear Pos. Bias", "Curv. Pos. Bias", "AE Est"), 6))
par(mfrow = c(4,5), mar = c(2,2, 1, 1), oma=c(4,4,2,2))
for (i in (1:30)[-takeout_ind]){
  boxplot(cbind(fratio_e[[i]][,69],bratio_e[[i]][,70]), ylim = c(-1.0, 1.0), axes = FALSE, 
          frame = TRUE)
  mtext(text=paste0("SM = ", OM_Title[i], ", EM = ", EM_Title[i]), side=3, line=0.15, cex=0.65, font=2)
  #  mtext(text=paste0("Convergence = ", summary_percent_true[i,4],"%"), side=1, line=-1, cex=1.3)
  if(i %in% 26:30){
...
#M and R0
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/M_R0_re_under2.tiff"), height=25, width=35, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Neg. Bias", 6), rep("Linear Neg. Bias", 6), rep("Curv. Neg. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Neg. Bias", "Linear Neg. Bias", "Curv. Neg. Bias",  "AE Est"), 6))
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/M_R0_re_over2.tiff"), height=25, width=35, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Pos. Bias", 6), rep("Linear Pos. Bias", 6), rep("Curv. Pos. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Pos. Bias", "Linear Pos. Bias", "Curv. Pos. Bias", "AE Est"), 6))
par(mfrow = c(4,5), mar = c(2,2, 1, 1), oma=c(4,4,2,2))
for (i in (1:30)[-takeout_ind]){
...
#msys
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/Fmsy_Bmsy_re_under2.tiff"), height=25, width=35, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Neg. Bias", 6), rep("Linear Neg. Bias", 6), rep("Curv. Neg. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Neg. Bias", "Linear Neg. Bias", "Curv. Neg. Bias",  "AE Est"), 6))
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/Fmsy_Bmsy_re_over2.tiff"), height=25, width=35, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Pos. Bias", 6), rep("Linear Pos. Bias", 6), rep("Curv. Pos. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Pos. Bias", "Linear Pos. Bias", "Curv. Pos. Bias", "AE Est"), 6))
par(mfrow = c(4,5), mar = c(2,2, 1, 1), oma=c(4,4,2,2))
for (i in (1:30)[-takeout_ind]){
...
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/F_re_under2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Neg. Bias", 6), rep("Linear Neg. Bias", 6), rep("Curv. Neg. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Neg. Bias", "Linear Neg. Bias", "Curv. Neg. Bias",  "AE Est"), 6))
#tiff(filename=("C:/Users/fischn/Documents/GitHub/Assessment_AgeingError/figures/F_re_over2.tiff"), height=35, width=50, units='cm', compression="lzw", res=500)
#OM_Title <- c(rep("No AE", 6),rep("No Bias", 6), rep("Const. Pos. Bias", 6), rep("Linear Pos. Bias", 6), rep("Curv. Pos. Bias", 6))
#EM_Title <- c(rep(c("No AE","No Bias", "Const. Pos. Bias", "Linear Pos. Bias", "Curv. Pos. Bias", "AE Est"), 6))
par(mfrow = c(4,5), mar = c(2,2, 1, 1), oma=c(4,4,2,2))
for (i in (1:30)[-takeout_ind]){
